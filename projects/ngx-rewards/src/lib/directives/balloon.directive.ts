...
import { animate, generatePhysics, getRandomInt } from '../helpers';
import { BalloonsConfig, Particle } from '../models';
...
@Directive({
  selector: '[ngxRewardsBalloon]',
})
export class BalloonDirective {
  isAnimating = false;

  @Input() balloonsConfig?: BalloonsConfig;

  @HostListener('click', ['$event.target'])
  onClick() {
    balloons(
      this.elementRef.nativeElement,
      this.internalAnimatingCallback,
      this.balloonsConfig
    );
  }
